...
public class Solution {
    public List<Integer> largestDivisibleSubset(int[] nums) {
        ...
        int n = nums.length;
        int[][] ans = new int[n][2];
        for (int i = 0; i < ans.length; i++) ans[i][1] = -1;
        int max = -1;
        int maxIndex = 0;
...
//        for (int i = 0; i < n; i++) {
//            System.out.println(nums[i] + ": " + ans[i][0] + ", " + ans[i][1]);
//        }
//        System.out.println(max);
//        System.out.println(maxIndex);
        for (int index = maxIndex; index != -1; index = ans[index][1]) list.add(nums[index]);
        return list;
    }
    ...
    public static void main(String[] args) {
        System.out.println(new Solution().largestDivisibleSubset(new int[] {1,2,3,4,6,8}));
